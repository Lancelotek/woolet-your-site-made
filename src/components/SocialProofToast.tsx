...
type Reservation = {
  ...
  model: string; // e.g. "009"
  createdAt: string; // ISO; for static data we synthesize at runtime
};

const STATIC_FOUNDERS: Omit<Reservation, "createdAt">[] = [
  // US
  { firstName: "Sarah", city: "Austin", region: "TX", model: "007" },
  { firstName: "Michael", city: "San Francisco", region: "CA", model: "009" },
  { firstName: "James", city: "Brooklyn", region: "NY", model: "009" },
  { firstName: "Tyler", city: "Seattle", region: "WA", model: "007" },
  { firstName: "David", city: "Boulder", region: "CO", model: "009" },
  { firstName: "Carlos", city: "Miami", region: "FL", model: "007" },
  { firstName: "Andrew", city: "Chicago", region: "IL", model: "009" },
  { firstName: "Brian", city: "Portland", region: "OR", model: "007" },
  { firstName: "Daniel", city: "Boston", region: "MA", model: "009" },
  { firstName: "Anthony", city: "Philadelphia", region: "PA", model: "007" },
  { firstName: "Emily", city: "Denver", region: "CO", model: "009" },
  { firstName: "Jake", city: "San Diego", region: "CA", model: "007" },
  { firstName: "Patrick", city: "Minneapolis", region: "MN", model: "009" },
  { firstName: "Ryan", city: "Atlanta", region: "GA", model: "007" },
  { firstName: "Steven", city: "Dallas", region: "TX", model: "009" },
  // EU
  { firstName: "Tomasz", city: "Warsaw", region: "PL", model: "009" },
  { firstName: "Marek", city: "Kraków", region: "PL", model: "007" },
  { firstName: "Lukas", city: "Munich", region: "DE", model: "009" },
  { firstName: "Felix", city: "Berlin", region: "DE", model: "007" },
  { firstName: "Sebastian", city: "Hamburg", region: "DE", model: "009" },
  { firstName: "Antoine", city: "Paris", region: "FR", model: "007" },
  { firstName: "Julien", city: "Lyon", region: "FR", model: "009" },
  { firstName: "Oliver", city: "London", region: "UK", model: "007" },
  { firstName: "Harry", city: "Manchester", region: "UK", model: "009" },
  { firstName: "Diego", city: "Barcelona", region: "ES", model: "007" },
  { firstName: "Marco", city: "Milan", region: "IT", model: "009" },
  { firstName: "Lorenzo", city: "Rome", region: "IT", model: "007" },
  { firstName: "Bas", city: "Amsterdam", region: "NL", model: "009" },
  { firstName: "Erik", city: "Stockholm", region: "SE", model: "007" },
  { firstName: "Andreas", city: "Zurich", region: "CH", model: "009" },
  { firstName: "Kasia", city: "Warsaw", region: "PL", model: "007" },
  { firstName: "Sophie", city: "Paris", region: "FR", model: "009" },
  { firstName: "Anna", city: "Berlin", region: "DE", model: "007" },
];
