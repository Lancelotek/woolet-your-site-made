        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2.5 mt-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              >
                ...
                <option className="bg-surface text-foreground">155 – 158 mm</option>
                <option className="bg-surface text-foreground">159 – 162 mm</option>
                <option className="bg-surface text-foreground">163 mm+</option>
                <option className="bg-surface text-foreground">Not sure — I'll measure</option>
              </select>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-5 flex-wrap">
              <CheckboxLabel label="Woolet 007" defaultChecked />
              <CheckboxLabel label="Woolet 009" defaultChecked />
            </div>
          </div>

          <button
            type="submit"
            className="relative overflow-hidden bg-primary text-primary-foreground border-none py-4 px-8 font-body font-semibold uppercase tracking-[0.28em] w-full transition-all hover:bg-gold-light active:scale-[0.99] group"
            style={{ fontSize: "0.66rem" }}
          >
            <span className="relative z-10">Claim My Spot — 15% Off + Free Shipping</span>
...
const CheckboxLabel = ({ label, defaultChecked }: { label: string; defaultChecked?: boolean }) => {
