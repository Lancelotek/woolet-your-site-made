...
const productCards = [
  {
    ...
    blurb: "Round Italian acetate frame, 158 mm wide with a 21 mm bridge. Bespoke from 145 to 172 mm.",
    href: "/en/products/007",
  },
  {
    id: "009",
    name: "Woolet 009 — Soft Square",
    blurb: "Soft-square Italian acetate frame, 158 mm wide with a 22 mm bridge. Bespoke from 145 to 172 mm.",
        ...
        <section style={{ background: "#1A1612", color: "#F8F6F1", padding: "20px 20px" }}>
          <div style={{ maxWidth: 760, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.6, color: "#CCC", margin: "0 0 14px" }}>
              Both shapes ship at 158 mm wide with a 21 mm bridge, engineered for faces in the 155-161 mm range. Outside that, bespoke covers 145 to 172 mm with the same 21 mm bridge.
        ...
        <section aria-label="Related collections" style={{ maxWidth: 760, margin: "0 auto", padding: "8px 20px 40px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {[
              ...
              { slug: "keyhole-bridge-glasses", label: "Keyhole Bridge Glasses" },
