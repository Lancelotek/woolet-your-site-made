...
const RESULTS: Record<Band, {
  ...
  "extra-wide": {
    ...
    honest:
      "Even our stock 158 mm will bow at the temples. Woolet Bespoke is cut to your exact face width (up to 172 mm) and bridge (16–26 mm), same Italian acetate, hand-finished in the EU. It's the only path that actually fits above 162 mm.",
