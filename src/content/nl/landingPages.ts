...
export const nlPages: Record<string, NlPageConfig> = {
  "acetaat-bril-op-maat": {
    ...
    sub: "Frontbreedte van 150 tot 172 mm, brug, veren en glashoogte individueel afgesteld. Italiaans Mazzucchelli 1849 acetaat, met de hand afgewerkt in de EU.",
    metaTitle: "Acetaat bril op maat 150–172 mm | Woolet — Italiaans acetaat",
    metaDescription:
      "Acetaat bril op maat voor bredere gezichten: front 150–172 mm, brug 16–26 mm, veren op maat. Italiaans Mazzucchelli-acetaat, handgemaakt in de EU. FitLens-meting in 20 s.",
    ...
    proofBullets: [
      { label: "Frontbreedte", value: "150 – 172 mm" },
    ...
    faqs: [
      {
        ...
        a: "Front: 150–172 mm. Brug: 16–26 mm. Veren: 135–155 mm. Ook de glashoogte is instelbaar.",
      },
      {
  ...
  "grote-brillen-heren": {
    ...
    metaTitle: "Grote brillen heren 155–172 mm | Woolet — Italiaans acetaat",
    metaDescription:
      "Grote brillen voor heren met een breed gezicht: frontbreedte 155/158/161 mm, plus bespoke tot 172 mm. 21 mm keyhole-brug, Italiaans acetaat, handgemaakt in de EU.",
    ...
    proofBody:
      "De 007 (rond) en 009 (zacht vierkant) worden geleverd in drie precieze maten — 155, 158 en 161 mm — met een 21–22 mm keyhole-brug en veren van 148 mm. Wie erboven of eronder valt, gaat naar Bespoke: 150–172 mm, in stappen van 1 mm. Alles gesneden uit Italiaans Mazzucchelli 1849 acetaat.",
    proofBullets: [
      { label: "Standaardbreedte", value: "155 / 158 / 161 mm" },
      { label: "Bespoke bereik", value: "150 – 172 mm" },
    ...
    faqs: [
      {
        ...
        a: "Woolet is ontworpen voor gezichten van 155 mm en breder, tot 172 mm via Bespoke.",
      },
      {
