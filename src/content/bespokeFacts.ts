export const BESPOKE_FACTS = {
  ...
  lenses: "Prescription lenses included",
  shapes: ["Aviator", "Rectangle / 009 Soft Square", "Crown Panto / 007 Round-Panto", "Round"],
  process: [
...
export const BESPOKE_FAQS = [
  ...
  { q: "How much do custom-made glasses cost?", a: "Woolet Bespoke costs $480 USD including prescription lenses and free worldwide shipping. During the Kickstarter campaign, backers get Bespoke for $299. The $299 Kickstarter backer price is available only through the campaign and is not sold as a $299 offer on woolet.co." },
  ...
  { q: "Can I use my prescription?", a: "Yes. The $480 regular price includes prescription lenses. You choose the lens type during configuration and provide the required prescription details before production." },
...
export function bespokeProductJsonLd(url = "https://woolet.co/en/bespoke", image = "https://woolet.co/og-image.png") {
  return {
    ...
    description: `${BESPOKE_FACTS.frontWidth} made-to-measure eyeglasses in ${BESPOKE_FACTS.material}, hand made in Greece (EU). Prescription lenses and free worldwide shipping included.`,
