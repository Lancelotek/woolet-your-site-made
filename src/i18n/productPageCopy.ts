...
export const BESPOKE_COPY: Record<PdpLang, BespokeCopy> = {
  en: {
    ...
    metaDescription: "Bespoke Italian Mazzucchelli acetate glasses cut to your exact face. Four silhouettes, sizes 145–172 mm. From $299 pre-order.",
    ogTitle: "Woolet Bespoke — Custom Acetate Glasses",
    ogDescription: "Bespoke Italian Mazzucchelli acetate glasses cut to your exact face. From $299 pre-order.",
    ...
    eyebrow: "Pre-order · Founders Bespoke · Ships Q4 2026",
  ...
  fr: {
    ...
    metaDescription: "Lunettes bespoke en acétate italien Mazzucchelli, taillées pour votre visage. Quatre silhouettes, tailles 145–172 mm. Dès 299 $ en pré-commande.",
    ogTitle: "Woolet Bespoke — lunettes en acétate sur mesure",
    ogDescription: "Lunettes bespoke en acétate italien Mazzucchelli, taillées pour votre visage. Dès 299 $ en pré-commande.",
    ...
    eyebrow: "Pré-commande · Founders Bespoke · Expédition T4 2026",
  ...
  nl: {
    ...
    metaDescription: "Bespoke Italiaanse Mazzucchelli-acetaatbril, gesneden op jouw gezicht. Vier silhouetten, maten 145–172 mm. Vanaf $299 in pre-order.",
    ogTitle: "Woolet Bespoke — acetaatbril op maat",
    ogDescription: "Bespoke Italiaanse Mazzucchelli-acetaatbril, gesneden op jouw gezicht. Vanaf $299 in pre-order.",
    ...
    eyebrow: "Pre-order · Founders Bespoke · Verzending Q4 2026",
