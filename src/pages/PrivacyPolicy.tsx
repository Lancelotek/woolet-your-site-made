      ...
      ? {
          ...
          content: (
            <>
              ...
              <p><strong className="text-foreground font-normal">Zdjęcie i przymiarka.</strong> Przed zakupem możesz na telefonie przesłać zdjęcie twarzy bez okularów, aby zobaczyć wcześniej wygenerowaną oprawkę na swojej twarzy. Samo wygenerowanie przymiarki nie zapisuje oryginału ani wyniku w naszym magazynie. Dopiero po wyświetleniu rezultatu możesz osobno wyrazić zgodę na zachowanie obu obrazów i przekazanie ich pracowni. Po zakupie nadal dostępny jest oddzielny, opcjonalny proces pomiarowy.</p>
      ...
      : {
          ...
          content: (
            <>
              ...
              <p><strong className="text-foreground font-normal">The photo and try-on.</strong> Before purchase, you may use a phone to submit a portrait without glasses and see your previously generated frame on your face. Generating the try-on does not save the original or result in our storage. Only after seeing the result may you separately consent to retaining both images and sharing them with the workshop. A separate optional measurement process remains available after purchase.</p>
