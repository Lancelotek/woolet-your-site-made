      ...
      <main style={{ background: "#F8F6F1", minHeight: "100vh", fontFamily: "'Barlow', sans-serif" }}>
        ...
        <div style={{ position: "relative", background: "#F8F6F1", padding: "20px 16px 0", display: "flex", justifyContent: "center" }}>
          ...
          >
            ...
            />
            <span style={{ position: "absolute", top: 10, right: 10, background: "rgba(26,22,18,0.78)", color: "#F0ECE4", fontFamily: "'Barlow', sans-serif", fontWeight: 500, fontSize: 11, letterSpacing: "1.5px", padding: "5px 9px", borderRadius: 999, textTransform: "uppercase", backdropFilter: "blur(6px)" }}>⤢ Zoom</span>
          </button>
        </div>
        ...
        <div style={{
          ...
          {selectedColorObj.name === "Havana — Founders" && (
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 6, padding: "4px 10px", background: "linear-gradient(135deg, #1A1612 0%, #2A2218 100%)", border: "1px solid #CAA449", borderRadius: 4 }}>
              <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 11, letterSpacing: "2px", color: "#CAA449", textTransform: "uppercase" }}>★ Founders Edition</span>
              <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 400, fontSize: 11, letterSpacing: "1px", color: "#E8DCC0", textTransform: "uppercase" }}>· Limited · 100 units only</span>
            </div>
          )}
          ...
          {/* Primary CTA */}
          <button onClick={handleCTA} style={{ width: "100%", background: "#CAA449", color: "#080807", border: "none", padding: "15px 0", borderRadius: 5, fontFamily: "'Barlow', sans-serif", fontWeight: 500, fontSize: 13, letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer", marginBottom: 8 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 10, padding: "6px 10px", background: "#FDF6EB", border: "1px solid #EFE2C8", borderRadius: 5 }}>
            ...
            <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 500, fontSize: 12, letterSpacing: "1.5px", color: "#A07A2A", textTransform: "uppercase" }}>Free worldwide shipping</span>
            <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 300, fontSize: 12, color: "#7A6A45" }}>· tracked & insured</span>
          </div>
          ...
          <div style={{ display: "flex" }}>
            {["Secure Payment", "Free Shipping", "30-Day Returns"].map((t, i) => (
              <div key={i} style={{ flex: 1, fontFamily: "'Barlow', sans-serif", fontWeight: 300, fontSize: 11, color: "#AAA", textAlign: "center", padding: "0 4px", lineHeight: 1.4 }}>{t}</div>
            ))}
          </div>
        </div>
        ...
        <div style={{ background: "#1A1612", padding: "16px 20px" }}>
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 500, fontSize: 11, letterSpacing: "3px", color: "#7A7570", textTransform: "uppercase", marginBottom: 10, marginTop: 0 }}>Specifications</h2>
            {specs.map(([key, val], i) => (
