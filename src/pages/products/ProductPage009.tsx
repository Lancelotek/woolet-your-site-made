...
const specs = [
  ["Materiał", "Włoski octan Mazzucchelli"],
  ["Szerokość oprawki", "158mm (hinge to hinge)"],
  ["Soczewka", "54 × 50mm (kwadratowa)"],
  ["Mostek", "Keyhole 21mm"],
  ["Zauszniki", "148mm, kąt 11°"],
  ["Zawiasy", "5-baryłkowe PVD Gunmetal"],
  ["Nity", "Podwójne, mosiądz PVD"],
];

const benefits = [
  "Włoski octan Mazzucchelli — bawełna, nie plastik",
  "158mm — projektowane dla twarzy 155mm+",
  "5-baryłkowe zawiasy PVD Gunmetal — trwałość 12+ miesięcy",
  "Mostek keyhole 21mm — zero ześlizgiwania",
  "Hand polish + bevel cut — nie machine polish",
];
...
const ProductPage009 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Woolet 009 — Premium Wide-Fit Acetate Eyewear (158mm) | Woolet</title>
        <meta name="description" content="Woolet 009 — kwadratowe oprawki z włoskiego octanu Mazzucchelli dla twarzy 158mm+. PVD Gunmetal zawiasy, mostek keyhole 21mm. Founding Member: 499 zł." />
      ...
      <div style={{ background: "#F8F6F1", minHeight: "100vh", fontFamily: "'Barlow', sans-serif" }}>
        ...
        <div style={{ padding: "14px 16px 24px" }}>
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 8 }}>
            <span style={{ background: "#FFF3E0", color: "#7A3800", padding: "3px 8px", borderRadius: 20, fontSize: 9, fontWeight: 500 }}>Sprzedaje się szybko</span>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 2, marginBottom: 8 }}>
            ...
            <span style={{ fontWeight: 300, fontSize: 10, color: "#888", marginLeft: 5 }}>4.9 · 4,900+</span>
          </div>

          {/* Product name */}
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 22, color: "#111", marginBottom: 4, marginTop: 0 }}>
            Woolet 009 <em style={{ fontStyle: "italic", fontSize: 15, color: "#888" }}>— Kwadratowa</em>
          </h1>

          {/* Price */}
          <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "8px 0 14px" }}>
            <span style={{ fontWeight: 600, fontSize: 22, color: "#A07A2A" }}>499 zł</span>
            <span style={{ fontWeight: 300, fontSize: 14, color: "#BBB", textDecoration: "line-through" }}>589 zł</span>
            <span style={{ background: "#CAA449", color: "#080807", padding: "2px 8px", borderRadius: 3, fontWeight: 500, fontSize: 9 }}>FOUNDING -90 ZŁ</span>
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button style={{ border: "2px solid #A07A2A", background: "#FDF6EB", fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 12, color: "#111", padding: "8px 16px", borderRadius: 5, cursor: "pointer" }}>009 Kwadratowa</button>
            </div>
          </div>

          {/* Color selector */}
          <div style={{ marginBottom: 14 }}>
            <div style={{ fontWeight: 500, fontSize: 9, letterSpacing: "2px", color: "#888", marginBottom: 8, textTransform: "uppercase" }}>KOLOR: <span style={{ color: "#111" }}>{selectedColor}</span></div>
          ...
          <button onClick={() => navigate("/en/fit")} style={{ width: "100%", background: "transparent", color: "#444", border: "2px solid #DDD", padding: "12px 0", borderRadius: 5, fontWeight: 300, fontSize: 12, cursor: "pointer", marginBottom: 14 }}>
            Sprawdź dopasowanie (quiz)
          </button>

          {/* Trust footer */}
          <div style={{ display: "flex" }}>
            {["Bezpieczna płatność", "30-dniowy zwrot", "Made in Italy"].map((t, i) => (
        ...
        <div style={{ background: "#1A1612", padding: "16px 20px" }}>
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            <div style={{ fontWeight: 500, fontSize: 9, letterSpacing: "3px", color: "#7A7570", textTransform: "uppercase", marginBottom: 10 }}>Specyfikacja</div>
            {specs.map(([key, val], i) => (
