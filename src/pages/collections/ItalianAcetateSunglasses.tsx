...
const ItalianAcetateSunglasses = () => (
  <CollectionPage
    ...
    metaDescription="Handmade in the EU from Italian Mazzucchelli acetate sunglasses for wide faces. Round and square. UV400. From $114."
    intro="Mazzucchelli has been producing cellulose acetate near Milan since 1849. Its sheet stock is the material most luxury eyewear houses cut from — denser, more colour-stable and easier to hand-finish than the injection-moulded plastic that dominates the rest of the market. Woolet's sunglasses are cut from that stock and hand made in EU, in one precise 158 mm size per shape."
    whyThisFits={[
    ...
    faqs={[
      ...
      { question: "Are the sunglasses Made in the EU?", answer: "The acetate is Italian (Mazzucchelli, Milan) and the hand-finishing — bevelling, polishing, inspection — is done in the EU. We do not claim each step of every component is Italian, which would be misleading." },
    ]}
  />
);
