...
const OversizedSquareGlasses = () => (
  <CollectionPage
    ...
    metaDescription="Oversized square glasses built for 155 mm+ faces. The 009 model: 158 mm front, soft-square silhouette, hand made in EU from Italian Mazzucchelli acetate."
