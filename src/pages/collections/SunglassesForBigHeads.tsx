...
const faqs = [
  {
    ...
    a: "Mainstream sunglasses sit at 138 to 148 mm across the front. Anything above 150 mm is wide. Woolet's standard size is 158 mm front width with a 21 mm bridge, and bespoke covers 145 to 172 mm. The first number printed inside the temple is lens width, not front width, so it can be misleading.",
  },
  {
    q: "What head circumference is considered big?",
    a: "Around 58 to 60 cm is large, 60 to 62 cm is XL, and above 62 cm is XXL. Woolet's standard 158 mm fits most XL heads (face width 155 to 161 mm). Outside that range, bespoke handles XS-wide and XXL faces from 145 to 172 mm.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Bespoke covers 145 to 172 mm of front width in either shape (007 round or 009 soft square), with temples up to 155 mm. Same Italian Mazzucchelli acetate as the standard line, made to your measurement.",
  },
  {
...
const sizeRows = [
  ...
  { hc: "Face width 150 to 154 mm or 162 to 162 mm", w: "Bespoke (made to measure)" },
];
...
const SunglassesForBigHeads = () => {
  ...
  const collectionLd = {
    ...
    description:
      "Sunglasses for big heads in one precise 158 mm front width, plus bespoke from 145 to 172 mm. Italian Mazzucchelli acetate, handmade in the EU, from $114 pre-order.",
    url: CANONICAL,
    inLanguage: "en",
  ...
  return (
    <>
      <SEO
        ...
        description="Sunglasses that actually fit big heads. 158 mm front, 21 mm bridge, hand-finished Mazzucchelli acetate."
        lang="en"
        path={PATH}
      ...
      <main style={{ background: "#F8F6F1", minHeight: "100vh", fontFamily: "'Barlow', sans-serif", color: "#111" }}>
        ...
        <header style={{ ...wrap, padding: "24px 20px 8px" }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.65, color: "#333", margin: "0 0 18px" }}>
            Built from the ground up for wide faces (155 mm+) and head circumference 58 to 62 cm, not retrofitted from standard sizes. Handmade in the EU from Italian Mazzucchelli acetate, two shapes, one precise 158 mm front plus bespoke up to 162 mm.
          </p>
        ...
        <section style={{ ...wrap, padding: "28px 20px 8px" }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.7, color: "#444", margin: 0 }}>
            Standard eyewear maxes out around 145 to 148 mm of front width. Woolet's standard is 158 mm with a 21 mm keyhole bridge, and bespoke covers anything from 145 to 172 mm.
          </p>
        </section>
        ...
        <section style={{ ...wrap, padding: "32px 20px 8px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
            {[
              ...
              { t: "Bespoke outside 155–161 mm", b: "Custom fronts from 145 to 172 mm in either shape. Same material, same finishing, made to your measurement." },
            ].map((c) => (
        ...
        <section style={{ ...wrap, padding: "28px 20px" }}>
          ...
          <div style={{ background: "#FFF", border: "1px solid #E0D5C5", borderRadius: 4, padding: "16px 18px", fontSize: 13, lineHeight: 1.7, color: "#333" }}>
            ...
            <p style={{ margin: 0 }}>
              <strong>Bespoke option.</strong> Fatheadz and similar specialists focus on plastic injection at one or two widths. Woolet is acetate at 158 mm, with bespoke from 145 to 172 mm.
            </p>
          </div>
        </section>
