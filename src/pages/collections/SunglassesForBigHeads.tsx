      ...
      <main style={{ background: "#F8F6F1", minHeight: "100vh", fontFamily: "'Barlow', sans-serif", color: "#111" }}>
        ...
        <header style={{ ...wrap, padding: "24px 20px 8px" }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.65, color: "#333", margin: "0 0 18px" }}>
            Built from the ground up for wide faces (155 mm+) and head circumference 58 to 62 cm, not retrofitted from standard sizes. Hand made in Greece (EU) from Italian Mazzucchelli acetate, two shapes, one precise 158 mm front plus bespoke from 145 to 172 mm.
          </p>
