...
const WideFaceGlasses = () => (
  <CollectionPage
    ...
    metaDescription="Glasses for wide faces and large faces: 158 mm front, 21 mm keyhole bridge, Italian acetate. Extended fit, prescription-ready, bespoke 145–172 mm."
