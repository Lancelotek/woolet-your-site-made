...
const WideFaceGlasses = () => (
  <CollectionPage
    ...
    faqs={[
      ...
      { question: "What is temple width and why does 158 mm matter?", answer: "Temple width is the total front width of the frame, measured hinge to hinge. 158 mm is Woolet's precise standard — engineered as the sweet spot for face widths around 155–161 mm. Outside that range, the bespoke tier (150–172 mm) takes over." },
