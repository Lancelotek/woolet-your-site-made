...
const ExtraLargeOversizedEyeglasses = () => (
  <CollectionPage
    ...
    whyThisFits={[
      ...
      "<strong>Bespoke 145–172 mm</strong> if you fall outside 155–161 mm. Same Italian acetate, same hand-finishing, made to your scan. Confirm your size with the <a href=\"/en/fit\" style=\"color:#A07A2A;\">AI Fit Wizard</a> or the <a href=\"/en/fit/manual\" style=\"color:#A07A2A;\">credit-card manual method</a>.",
    ]}
    faqs={[
      {
