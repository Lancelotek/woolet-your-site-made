...
const OversizedRoundGlasses = () => (
  <CollectionPage
    slug="oversized-round-glasses"
    ...
    faqs={[
      {
        question: "Do oversized round glasses suit wide faces?",
        answer:
          "They do — round frames soften angular jawlines and balance strong horizontal features common to wide faces. The constraint is front width: a 145 mm round on a 160 mm face looks too small. The 007 is built at 158 mm specifically to keep the round silhouette in proportion.",
      },
      {
        question: "What's the difference between round and panto frames?",
        answer:
          "True round is a full circle (top and bottom curves are mirror images). Panto is rounder at the top and slightly flatter at the bottom, originally for medical use. The 007 is true round — the classic 1920s–70s silhouette, not a panto compromise.",
      },
      {
        question: "Can I get the 007 as prescription glasses?",
        answer:
          "Yes — single-vision, progressive, blue-light filter, or sunglass tint. The 52 mm lens diameter gives progressive lenses a full corridor and accommodates strong prescriptions without edge thickness issues.",
      },
      {
        question: "Are oversized round glasses in style for men?",
        answer:
          "Yes — round frames have been a staple of architectural and creative-industry style for decades, and oversized round is back in rotation in 2026. The 007's 158 mm front keeps the look proportional for wide-faced wearers who normally can't pull off small fashion rounds.",
      },
      {
...
export default OversizedRoundGlasses;
