...
const GlassesForBigHeads = () => (
  <CollectionPage
    ...
    extraSections={[
      {
        ...
        paragraphs: [
          ...
          "<strong>XXL · 62 cm and above</strong> → 164–162 mm front. Bespoke only — same Italian Mazzucchelli acetate, hand-finished in the EU to your measurement.",
    ...
    faqs={[
      ...
      { question: "What if 158 mm is still too narrow?", answer: "Bespoke covers 145 to 162 mm of front width in either shape, with a 20–24 mm bridge and temples up to 155 mm. Same Italian Mazzucchelli acetate, hand-finished in the EU to your measurement." },
