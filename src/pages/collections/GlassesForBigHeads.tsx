...
const GlassesForBigHeads = () => (
  <CollectionPage
    ...
    metaDescription="Glasses for big heads and eyeglasses for wide heads: 158 mm Italian acetate frames, fits 58–62 cm heads. Prescription-ready, bespoke to 162 mm."
    intro="Glasses for big heads need a wider front, a stronger bridge and hinges that actually hold. Most optical frames stop at 138–148 mm and pinch anyone with a 58 cm+ head circumference. Woolet starts at 158 mm — round 007 and soft-square 009 — in hand made in EU from Italian Mazzucchelli acetate, prescription-ready, with bespoke sizing up to 162 mm."
    whyThisFits={[
    ...
    extraSections={[
      {
        heading: "Sizing chart: head circumference to frame width",
        paragraphs: [
          ...
          "<strong>XXL · 62 cm and above</strong> → 164–162 mm front. Bespoke only — same Italian Mazzucchelli acetate, hand made in EU to your measurement.",
      ...
      {
        heading: "Where to buy glasses for big heads",
        paragraphs: [
          "Most direct-to-consumer eyewear brands cap their widest frame at around 148–152 mm, which is still narrow for a 60 cm+ head. The shortlist of brands that genuinely fit big heads is small: a few extended-fit collections at large optical retailers, a handful of specialist brands, and Woolet.",
          "Woolet is built around one constraint: wide faces and big heads. Every frame ships at 158 mm and bespoke goes to 162 mm. There is no narrow line. You can <a href=\"/en/products/007\" style=\"color:#A07A2A;\">view the 007 (round)</a> or <a href=\"/en/products/009\" style=\"color:#A07A2A;\">view the 009 (soft-square)</a>, or run the <a href=\"/en/fit\" style=\"color:#A07A2A;\">30-second fit scan</a> first to confirm 158 mm matches your head circumference.",
        ],
      },
    ]}
    faqs={[
      { question: "What size glasses for a big head?", answer: "For a 58–60 cm head, a 152–158 mm front. For 60–62 cm, 158–164 mm. For 62 cm and above, 164–162 mm. Woolet's standard 158 mm front covers most large to XL heads; bespoke handles XXL." },
      ...
      { question: "Where to buy glasses for big heads?", answer: "A small group of brands actually fits 58 cm+ heads — most direct-to-consumer eyewear caps around 148 mm. Woolet ships every frame at 158 mm with bespoke to 162 mm in Italian Mazzucchelli acetate, prescription-ready." },
      ...
      { question: "Can I get prescription lenses fitted?", answer: "Yes. Both shapes ship ready for any optician to fit single-vision, progressive or blue-light lenses. Lens area is generous enough for progressives without distortion at the edges." },
      { question: "What if 158 mm is still too narrow?", answer: "Bespoke covers 145 to 162 mm of front width in either shape, with a 20–24 mm bridge and temples up to 155 mm. Same Italian Mazzucchelli acetate, hand made in EU to your measurement." },
