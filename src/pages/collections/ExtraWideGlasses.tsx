...
const ExtraWideGlasses = () => (
  <CollectionPage
    ...
    whyThisFits={[
      ...
      "Both shapes — round 007 and soft-square 009 — are cut from Italian Mazzucchelli cellulose acetate, the same block material used by Persol and Tom Ford. Hand Finished in the EU, 5-barrel PVD Gunmetal hinges, 150 mm temples at 11°.",
