...
const ExtraWideGlasses = () => (
  <CollectionPage
    ...
    faqs={[
      ...
      { question: "Can I go wider than 158 mm?", answer: "Yes. Bespoke covers 145 to 162 mm of front width in either shape, with temples up to 155 mm. Hand-crafted from your scan." },
